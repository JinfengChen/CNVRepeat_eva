...
mkdir $folder
cd $folder
ln -s /rhome/cjinfeng/BigData/00.RD/RelocaTE_i/ReadMapping/MSU7.$chr\.$repeat/MSU7.$chr\.$repeat\.rep1_reads/MSU7.$chr\.$repeat\.rep1_reads_$depth\_100_500.bam* ./
ln -s /rhome/cjinfeng/BigData/00.RD/RelocaTE_i/Simulation/MSU7.$chr\.$repeat/MSU7.$chr\.$repeat\.rep1_reads/MSU7.$chr\.$repeat\.rep1_reads_$depth\_100_500_*.fq.gz ./
...
json="
{\n 
\t\"ref_fasta\":\"/rhome/cjinfeng/BigData/00.RD/CNVRepeat/example_$chr\_$depth/MSU7.$chr\.fa\",\n
\t\"gtf\":\"\",\n
\t\"bam\":\"/rhome/cjinfeng/BigData/00.RD/CNVRepeat/example_$chr\_$depth\/MSU7.$chr\.ALL.rep1_reads_$depth\_100_500.bam\",\n
\t\"fastq1\":\"/rhome/cjinfeng/BigData/00.RD/CNVRepeat/example_$chr\_$depth\/MSU7.$chr\.ALL.rep1_reads_$depth\_100_500_1.fq.gz\",\n
\t\"fastq2\":\"/rhome/cjinfeng/BigData/00.RD/CNVRepeat/example_$chr\_$depth\/MSU7.$chr\.ALL.rep1_reads_$depth\_100_500_2.fq.gz\",\n
\t\"bed\":\"/rhome/cjinfeng/BigData/00.RD/CNVRepeat/example_$chr\_$depth\/MSU7.$chr\.exon.single_exon.bed\",\n
\t\"repeat\":\"/rhome/cjinfeng/BigData/00.RD/CNVRepeat/example/mping.fa\",\n
\t\"output\":\"/rhome/cjinfeng/BigData/00.RD/CNVRepeat/example_$chr\_$depth\/CNVRepeat_output\",\n
\t\"binaries\": {\n
